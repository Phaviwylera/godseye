...
const CACHE = 'godseye-shell-v7';
const CORE = ['./', './index.html', './css/style.css', './js/app.js', './js/players.js',
              './js/intel.js', './js/sources.js', './js/satellites.js', './js/vessels.js', './vendor/maplibre-gl.js', './vendor/maplibre-gl.css', './vendor/satellite.min.js',
